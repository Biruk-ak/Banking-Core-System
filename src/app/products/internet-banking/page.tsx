...
export default function InternetBankingPage() {
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-semibold text-white">Internet Banking</h1>
        <p className="mt-2 text-slate-400">
          Banking Core System module for internet banking operations, monitoring, and customer workflows.
        </p>
      </div>
