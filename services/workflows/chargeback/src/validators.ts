import type { ChargebackContext } from './workflow';
...
export function validateChargeback(ctx: ChargebackContext): ValidationIssue[] {
...
export function assertValidChargeback(ctx: ChargebackContext): void {
  const issues = validateChargeback(ctx);
