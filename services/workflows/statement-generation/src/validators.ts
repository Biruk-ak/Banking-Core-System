import type { StatementGenerationContext } from './workflow';
...
export function validateStatementGeneration(ctx: StatementGenerationContext): ValidationIssue[] {
...
export function assertValidStatementGeneration(ctx: StatementGenerationContext): void {
  const issues = validateStatementGeneration(ctx);
