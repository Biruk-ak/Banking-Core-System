import type { DirectDebitContext } from './workflow';
...
export function validateDirectDebit(ctx: DirectDebitContext): ValidationIssue[] {
...
export function assertValidDirectDebit(ctx: DirectDebitContext): void {
  const issues = validateDirectDebit(ctx);
