import type { LimitManagementContext } from './workflow';
...
export function validateLimitManagement(ctx: LimitManagementContext): ValidationIssue[] {
...
export function assertValidLimitManagement(ctx: LimitManagementContext): void {
  const issues = validateLimitManagement(ctx);
