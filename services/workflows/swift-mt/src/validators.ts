import type { SwiftMtContext } from './workflow';
...
export function validateSwiftMt(ctx: SwiftMtContext): ValidationIssue[] {
...
export function assertValidSwiftMt(ctx: SwiftMtContext): void {
  const issues = validateSwiftMt(ctx);
