import type { RegulatoryReportingContext } from './workflow';
...
export function validateRegulatoryReporting(ctx: RegulatoryReportingContext): ValidationIssue[] {
...
export function assertValidRegulatoryReporting(ctx: RegulatoryReportingContext): void {
  const issues = validateRegulatoryReporting(ctx);
