import type { ClaimsProcessingContext } from './workflow';
...
export function validateClaimsProcessing(ctx: ClaimsProcessingContext): ValidationIssue[] {
...
export function assertValidClaimsProcessing(ctx: ClaimsProcessingContext): void {
  const issues = validateClaimsProcessing(ctx);
