import type { TaxReportingContext } from './workflow';
...
export function validateTaxReporting(ctx: TaxReportingContext): ValidationIssue[] {
...
export function assertValidTaxReporting(ctx: TaxReportingContext): void {
  const issues = validateTaxReporting(ctx);
