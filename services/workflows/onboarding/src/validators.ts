import type { OnboardingContext } from './workflow';
...
export function validateOnboarding(ctx: OnboardingContext): ValidationIssue[] {
...
export function assertValidOnboarding(ctx: OnboardingContext): void {
  const issues = validateOnboarding(ctx);
