import type { CollectionsContext } from './workflow';
...
export function validateCollections(ctx: CollectionsContext): ValidationIssue[] {
...
export function assertValidCollections(ctx: CollectionsContext): void {
  const issues = validateCollections(ctx);
