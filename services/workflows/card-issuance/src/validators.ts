import type { CardIssuanceContext } from './workflow';
...
export function validateCardIssuance(ctx: CardIssuanceContext): ValidationIssue[] {
...
export function assertValidCardIssuance(ctx: CardIssuanceContext): void {
  const issues = validateCardIssuance(ctx);
