import type { RestructuringContext } from './workflow';
...
export function validateRestructuring(ctx: RestructuringContext): ValidationIssue[] {
...
export function assertValidRestructuring(ctx: RestructuringContext): void {
  const issues = validateRestructuring(ctx);
