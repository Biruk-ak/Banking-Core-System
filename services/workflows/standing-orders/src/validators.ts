import type { StandingOrdersContext } from './workflow';
...
export function validateStandingOrders(ctx: StandingOrdersContext): ValidationIssue[] {
...
export function assertValidStandingOrders(ctx: StandingOrdersContext): void {
  const issues = validateStandingOrders(ctx);
