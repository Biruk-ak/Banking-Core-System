import type { PayrollDisbursementContext } from './workflow';
...
export function validatePayrollDisbursement(ctx: PayrollDisbursementContext): ValidationIssue[] {
...
export function assertValidPayrollDisbursement(ctx: PayrollDisbursementContext): void {
  const issues = validatePayrollDisbursement(ctx);
