import type { LoanOriginationContext } from './workflow';
...
export function validateLoanOrigination(ctx: LoanOriginationContext): ValidationIssue[] {
...
export function assertValidLoanOrigination(ctx: LoanOriginationContext): void {
  const issues = validateLoanOrigination(ctx);
