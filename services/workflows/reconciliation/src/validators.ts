import type { ReconciliationContext } from './workflow';
...
export function validateReconciliation(ctx: ReconciliationContext): ValidationIssue[] {
...
export function assertValidReconciliation(ctx: ReconciliationContext): void {
  const issues = validateReconciliation(ctx);
