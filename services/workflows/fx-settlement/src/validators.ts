import type { FxSettlementContext } from './workflow';
...
export function validateFxSettlement(ctx: FxSettlementContext): ValidationIssue[] {
...
export function assertValidFxSettlement(ctx: FxSettlementContext): void {
  const issues = validateFxSettlement(ctx);
