import type { CollateralMgmtContext } from './workflow';
...
export function validateCollateralMgmt(ctx: CollateralMgmtContext): ValidationIssue[] {
...
export function assertValidCollateralMgmt(ctx: CollateralMgmtContext): void {
  const issues = validateCollateralMgmt(ctx);
